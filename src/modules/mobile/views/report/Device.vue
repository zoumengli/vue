            ...
            <div class="tableContent">
                <table class="table-list">
                    ...
                    <tr v-for="(item,index) in pagination.items" :key="index">
                        ...
                        <td><span class="f-blue">{{item.runningRateStr}}</span></td>
                        <td><span class="f-red">{{item.errorRateStr}}</span></td>
                        <td><span>{{item.productAmount}}</span></td>
...
<script>
    ...
    import { getAppReportDeviceInfo} from '../../../../lib/api';
    export default {
        data: function () {
            return {
                selected: '1',
        ...
        methods: {
            fetchItems(){
               ...
               /* let factoryId;
                ...
                AjaxApi.ajaxPost(getAppReportDeviceInfo, params, (response) => {
                    this.loading = false;
